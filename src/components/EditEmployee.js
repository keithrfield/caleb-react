  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Footer>        
          <button className="border border-purple-700 bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded" form="editmodal">Save Changes</button>
          <button className="border border-slate-700 bg-slate-500 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded" onClick={handleClose}>Close</button>
        </Modal.Footer>
      </Modal>
    </>
  );
